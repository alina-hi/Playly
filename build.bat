...
if errorlevel 1 goto failed
echo Step 5: Compiling LoginServlet...
javac -encoding UTF-8 -cp "lib\*;classes" -d classes src\com\playly\LoginServlet.java

echo Step 6: Compiling LogoutServlet...
javac -encoding UTF-8 -cp "lib\*;classes" -d classes src\com\playly\LogoutServlet.java
